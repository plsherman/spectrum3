...
// ****** Diagnostic/test parameters  ********
 ...
 static int[]    spectraLocLeft ={180,70,220,1510}	// ******** X2 <> colsIn *****
	            	,spectraLocRight={890,70,930,1510};

 static int	 zeroPointLeft  =  75	// displacement from loc to center of slit
	         	,zeroPointRight =  84;	// 7 original
/*
 static double   nmPerPixelLeft  = 0.6349206
...
public static int  exposureCuvette = 10000  // 60000
